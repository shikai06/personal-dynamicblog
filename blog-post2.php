                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="blog-home.php">Text Blogs</a>
                            </li>
                            <li>
                                 <a href="blog-home2.php">Image Blogs</a>
                            </li>
...
<?php
  include "config.php";
      ...
      $Title=$DatePost=$Image=$Firstline=$Secondline="";
      $ID=0; //variables

          if(isset($_GET['id']) and $_SERVER["REQUEST_METHOD"]=="GET")//request method to GET
          { 
              $ID=$_GET["id"];
              $sql = "SELECT * FROM iblogtbl WHERE ID=".$ID.""; //Query getting recent data
              $rs=$conn->query($sql);
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Preview Image -->
                <img class="img-responsive" src="../WEBDEVDYNAMIC3/article/<?php echo $Image;?>" alt="">
