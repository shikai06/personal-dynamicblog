...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-edit"></i> About Form
                            </li>
                        </ol>
                    </div>
                </div>
  ...
  include "config.php";
      ...
      $ID=0; //variables
          ...
          $sql = "SELECT * FROM aboutbl WHERE ID = 1"; //Query getting recent data
              $rs=$conn->query($sql);
...

            {
                ...
                $sql = "UPDATE aboutbl SET Title='$Title', Paragraph='$Paragraph' WHERE ID = 1";
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                            ...
                            <div class="form-group">
                                <textarea class='form-control ckeditor' name='Paragraph' rows='3'><?php echo $Paragraph;?></textarea>
                            </div>
