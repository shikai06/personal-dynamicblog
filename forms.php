                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                         ...
                         <div class="jumbotron">
                    <h1>We must not only blog what is popular. We must blog our passions, no matter how quaint.</h1>
                    </p>
                </div>
                    </div>
                </div>
...
if(isset($_POST) and $_SERVER["REQUEST_METHOD"]=="POST") //checking request method
{
  ...
  $mysqli = "INSERT INTO tblogtbl(Title, DatePost, Firstline, Secondline, Thirdline)
  VALUES('".$_POST["Title"]."','".$_POST["DatePost"]."','".$_POST["Firstline"]."'),'".$_POST["Secondline"]."'),'".$_POST["Thirdline"]."')";
